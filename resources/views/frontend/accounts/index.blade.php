            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('accounts.create') }}" class="btn btn-default">Adicionar Conta</a>
                    </div>
                    <div class="card-body">
...
@section('script')
<script src="/assets/frontend/js/accounts/index.js"></script>
