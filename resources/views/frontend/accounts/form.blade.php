...
@section('title', 'Frontend | ' . (isset($currency) ? 'Editar' : 'Adicionar') . ' Conta ')

@section('breadcrumb')
<li class="breadcrumb-item"><a class="text-white" href="{{ route('accounts.index') }}">Moedas</a></li>
...
<section class="content">
    <form id="form" 
        action="{{ isset($currency) ? route('api.accounts.update', $currency->id) : route('api.accounts.store') }}">
    @csrf
...
@section('script')
<script src="/assets/admin/js/accounts/form.js"></script>
