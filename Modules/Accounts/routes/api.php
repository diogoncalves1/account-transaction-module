...
Route::group([
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('transactions/data', [\Modules\Accounts\Http\Controllers\Api\V1\TransactionController::class, 'dataTable']);
            Route::resource('transactions', \Modules\Accounts\Http\Controllers\Api\V1\TransactionController::class, ['except' => ['index', 'show', 'create', 'edit']]);
